 ...
 */
final class Version20190308193027 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE google_calendar (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, INDEX IDX_6A8CC36EA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
